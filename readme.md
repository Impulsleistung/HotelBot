...
- Usage of an Artifical Intelligence with focus on
  - Natural Language Processing
  - Backend Server System
- 100% Cloud developed prototype
...
The standard Dialogflow followup for cancel is used. No explicit phrases
###  ReservationBook - yes
...
The standard Dialogflow followup for confirmation is used. No explicit phrases
